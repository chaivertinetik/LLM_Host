...
graph_requirement = [   
                        ...
                        'CRITICAL DATA RULE FOR CARDIFF: When the user queries about Cardiff tree crowns or trees in general, you must load the polygons geoJson: TreeCrowns_CC_Cardiff_HighVeryHighRisk ( DO NOT use ArbotrackPoints_CC_07102025 for tree crown or canopy queries, as it lacks polygon geometry. Only use ArbotrackPoints_CC_07102025 if the user explicitly mentions they want points).',
...
operation_requirement = [
    ...
    "The python code can follow something like: healthy_trees = gdf[(gdf['Health'].notnull() & gdf['Health'].str.contains(r'\bhealthy\b|1', case=False, na=False, regex=True)) | (gdf['Condition'].notnull() & gdf['Condition'].str.lower().str.contains('adb class 1 100-76 crown remains', na=False, regex=True))] and ensure regex=True",
