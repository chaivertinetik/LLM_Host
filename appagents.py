...
def _preload_single_dataset(entry: str, idx: int, datasets_dir: str) -> Optional[Dict[str, Any]]:
   ...
   local_geojson = os.path.join(datasets_dir, f"{idx:03d}_{dataset_key}_{url_hash}.geojson")
   local_parquet = os.path.join(datasets_dir, f"{idx:03d}_{dataset_key}_{url_hash}.parquet")
   ...
   if os.path.exists(local_parquet):
       try:
           ...
           gdf = None
   if gdf is None and os.path.exists(local_geojson):
       try:
   ...
   preferred_local_path = local_parquet if os.path.exists(local_parquet) else local_geojson
   preferred_local_format = 'parquet' if os.path.exists(local_parquet) else 'geojson'
...
def _iter_data_location_entries(data_locations: list) -> list[Dict[str, Any]]:
   ...
   for idx, entry in enumerate(data_locations or [], start=1):
       ...
       dataset_key = _slugify_dataset_name(label.lower(), fallback=f'dataset_{idx}')
       entries.append(
           f"Local cached dataset: {label}: {local_path}\n"
           f"  dataset_key: {dataset_key}\n"
           f"  local_format: {local_format}\n"
           f"  feature_count: {meta.get('feature_count', 0)}\n"
           f"  geometry_types: {geom_types or 'unknown'}\n"
...
def build_preloaded_dataset_context(data_locations: list, save_dir: str, max_workers: Optional[int] = None) -> Dict[str, Any]:
   ...
   for key, meta in dataset_catalog.items():
       try:
           if meta.get('local_parquet') and os.path.exists(meta['local_parquet']):
               datasets[key] = gpd.read_parquet(meta['local_parquet'])
           else:
   ...
   for idx, meta in enumerate(manifests, start=1):
       ...
       prompt_lines.append(
           f"{idx}. {meta['label']} => datasets['{meta['dataset_key']}'] | local_path={local_path} | local_format={meta.get('local_format', 'geojson')} | "
...
def _build_llm_local_data_locations(dataset_context: Dict[str, Any]) -> list[str]:
   entries = []
   catalog = dataset_context.get('dataset_catalog') or {}
   for idx, (dataset_key, meta) in enumerate(catalog.items(), start=1):
       local_path = meta.get('local_path') or meta.get('local_parquet') or meta.get('local_geojson') or ''
       local_format = meta.get('local_format') or ('parquet' if meta.get('local_parquet') else 'geojson')
       cols = ', '.join(meta.get('columns') or [])
       geom_types = ', '.join(meta.get('geometry_types') or [])
...
def alpha_earth_reasoning(geometry, operation="classify"):
    ...
    anchors = {
        "forest": np.array([np.float64(-0.2069357939254133), np.float64(-0.16000000000000003), np.float64(-0.16633602460592078), np.float64(0.003936947327950788), np.float64(0.0629911572472126), np.float64(-0.008858131487889272), np.float64(0.2599000384467512), np.float64(-0.05173394848135333), np.float64(0.14769703960015382), np.float64(-0.05173394848135333), np.float64(0.01574778931180315), np.float64(0.11374086889657825), np.float64(-0.11909265667051133), np.float64(0.05536332179930796), np.float64(-0.10340638216070744), np.float64(0.13016532103037293), np.float64(-0.09842368319876971), np.float64(0.044844290657439445), np.float64(-0.05911572472126105), np.float64(-0.15378700499807765), np.float64(-0.03844675124951941), np.float64(-0.019930795847750864), np.float64(-0.13588619761630144), np.float64(0.2761399461745483), np.float64(0.21413302575932336), np.float64(-0.13016532103037293), np.float64(0.186082276047674), np.float64(0.0629911572472126), np.float64(0.09842368319876971), np.float